@extends('layouts.app')
<title>Edit Kepala Puskesmas - SPPD Puskesmas Gondosari</title>
@section('content')
    <style>
        .custom-border {
            ...
            <div class="col-lg-12">
                <div class="card custom-card">
                    <div class="card-header">
                        <h2 class="card-title " style="font-weight: bold; font-size: 25px">Edit Kepala Puskesmas</h2>
                    </div>
                    <hr class="m-0" style="opacity: 30%;
        height: 0.7px; ">
                    <div class="card-body">
                        <div class="basic-form">
                            <form action="{{ route('head-health-put', ['id' => $headHealth->id]) }}"
                                ...
                                <div class="mb-5">
                                    ...
                                    <input type="number" class="form-control input-default custom-border"
                                        ...
                                        value="{{ $headHealth['transport_money'] }}">
                                </div>
                                <input type="text" name="role" value="employee" hidden>
                                <a href="{{ route('head-health') }}" class="btn me-2 btn-dark">Kembali</a>
