@extends('layouts.app')
<title>Edit Kategori - SPPD Puskesmas Gondosari</title>
@section('content')
    <style>
        .custom-border {
        ...
        height: 0.7px; ">
                    <div class="card-body">
                        <div class="basic-form">
                            <form method="post" action="{{ route('categories-put', ['id' => $category->id]) }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control input-default custom-border"
                                        placeholder="Masukkan Nama Kategori" value="{{ $category->name }}" name="name">
                                </div>

                                <a href="{{ route('categories') }}" class="btn me-2 btn-dark">Kembali</a>
