@extends('layouts.app')
<title>Tambah Kader - SPPD Puskesmas Gondosari</title>
@section('content')
    <style>
        .custom-border {
            ...
            <div class="col-lg-12">
                <div class="card custom-card">
                    <div class="card-header">
                        <h2 class="card-title " style="font-weight: bold; font-size: 25px">Tambah Kader</h2>
                    </div>
                    <hr class="m-0" style="opacity: 30%;
        height: 0.7px; ">
                    <div class="card-body">
                        <div class="basic-form">
                            <form action="{{ route('cadress-post') }}" class="form-valide-with-icon needs-validation"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control input-default custom-border"
                                        placeholder="Masukkan Jabatan " name="position" value="-">
                                </div>
                                <div class="mb-3">
                                ...
                                <input type="text" name="role" value="cadres" hidden>
