\@extends('layouts.app')
<title>Tambah Akun - SPPD Puskesmas Gondosari</title>
@section('content')
    <style>
        .custom-border {
            ...
            <div class="col-lg-12">
                <div class="card custom-card">
                    <div class="card-header">
                        <h2 class="card-title " style="font-weight: bold; font-size: 25px">Tambah Akun</h2>
                    </div>
                            ...
                            <form method="post" action="{{ route('account-post') }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control input-default custom-border"
                                        placeholder="Masukkan Nama Akun" name="name">
                                </div>

                                <a href="{{ route('account', ['id' => 1]) }}" class="btn me-2 btn-dark">Kembali</a>
