\@extends('layouts.app')
<title>Tambah Tipe Tujuan - SPPD Puskesmas Gondosari</title>
@section('content')
    <style>
        .custom-border {
            ...
            <div class="col-lg-12">
                <div class="card custom-card">
                    <div class="card-header">
                        <h2 class="card-title " style="font-weight: bold; font-size: 25px">Tambah Tipe Tujuan</h2>
                    </div>
                    <hr class="m-0" style="opacity: 30%;
        height: 0.7px; ">
                    <div class="card-body">
                        <div class="basic-form">
                            <form action="{{ route('type-destination-post') }}" method="post"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control input-default custom-border"
                                        placeholder="Masukkan Nama Tipe Tujuan" name="name">
                                </div>

                                <a href="{{ route('type-destination', ['id' => 1]) }}" class="btn me-2 btn-dark">Kembali</a>
