@extends('layouts.app')
<title>Data Kader - SPPD Puskesmas Gondosari</title>
@section('content')
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 text-md-end">
                                ...
                                <div class="btn-group" role="group" aria-label="Basic mixed styles example"
                                    ...
                                    <div class="btn-group">
                                        <a href="{{ route('cadress-export', ['id' => 1]) }}" type="button"
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header pb-0">
                        <h2 class="card-title " style="font-weight: bold; font-size: 25px">Data Kader</h2>
                    </div>
                    <div class="card-body">
    ...
    <div class="modal fade" id="import-cadress">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('cadress-import') }}" method="post" enctype="multipart/form-data">
                    @method('post')
                    @csrf
                    <div class="modal-body">
