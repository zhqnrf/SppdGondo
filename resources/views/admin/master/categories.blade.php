@extends('layouts.app')
<title>Data Kategori - SPPD Puskesmas Gondosari</title>
@section('content')
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header pb-0">
                        <h2 class="card-title " style="font-weight: bold; font-size: 25px">Data Kategori</h2>
                    </div>
                    <div class="card-body">
    ...
    <div class="modal fade" id="delete-categories">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" style="font-weight: bold; font-size: 30px">Hapus Kategori</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal">
                    </button>
                </div>
                <div class="modal-body">
                    <p class="pt-3" style="font-size: 17px">Apakah anda yakin ingin menghapus Kategori ini?</p>
                </div>
