@extends('layouts.app')
<title>Data Biaya - SPPD Puskesmas Gondosari</title>
@section('content')
                    ...
                    <div class="card-body p-0 pt-3 pb-3 pe-3">
                        <div class="row">
                            ...
                            <div class="col-sm-6 text-md-end">
                                <a href="{{ route('cost-template') }}"><button class="btn btn-secondary me-2">
                                        Download Template
                                    </button></a>
                                <a href="{{ route('add-cost') }}">
                                ...
                                <div class="btn-group" role="group" aria-label="Basic mixed styles example"
                                    ...
                                    <div class="btn-group">
                                        <a href="{{ route('cost-export', ['id' => 1]) }}" class="btn btn-success"
                                            aria-expanded="false">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                ...
                                <tbody>
                                    ...
                                    @foreach ($data as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex ">
                                                    <a href="{{ route('edit-cost', ['id' => $item['id']]) }}"
                                                    ...
                                                    <button class="btn-delete btn btn-danger shadow btn-xs sharp pt-2"
                                                        data-bs-toggle="modal" data-bs-target="#delete-cost"
                                                        data-id="{{ $item['id'] }}">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form action="{{ route('cost-delete') }}" method="post">
                        @method('delete')
                        @csrf
                        <input type="text" name="id" id="id-cost" hidden>
    ...
    <div class="modal fade" id="button-import">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <div class="row-12">
                        <h5 class="modal-title" style="font-weight: bold; font-size: 30px">Upload Biaya</h5>

                    </div>
                    <button type="button" class="btn-close" data-bs-dismiss="modal">
                    </button>
                </div>
                <form action="{{ route('cost-import', ['id' => 1]) }}" method="post" enctype="multipart/form-data">
                    @method('post')
                    @csrf
                    <div class="modal-body">
